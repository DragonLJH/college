...
<div class="leibie-div " :style="{'--padding-r':openR?'300px':'20px'}">
    ...
    <div class="leibie-div-main">
        <control-div v-for="(item, index) in mainItems" :key="item.id" v-model='item.style' :is-setting="false">
            ...
            <template v-if="item.is == 'card-view-div'">
                <card-view-div :index="index" :title="item.title" :title-icon="item.titleIcon"  :img-data="item.imgData"  @target="targetProgress"></card-view-div>
            </template>
        </control-div>   
    </div>
    ...
    <div class="leibie-div-right" :style="{'--width':openR?'300px':'20px'}">
        ...
        <div class="leibie-div-right-main" v-show="openR">
            <template v-if="Object.keys(progressMsg).length">
                ...
                <div class="leibie-div-right-main-msg" v-for="(item, index) in progressMsg.data" :key="index" >
                    <div class="leibie-div-right-main-msg-title" :class="item.icon?'':'default'" @click="openMask"><div class="icon icon-s" :class="item.icon" v-if="item.icon"></div> {{item.title}}</div>
